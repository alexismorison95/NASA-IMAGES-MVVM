package com.morris.nasaimages.modules.main.data.local
        ...
        return listOf(
            MainItem(
                ...
                "Astronomy Picture of the Day (APOD) is a website provided by NASA and " +
                        ...
                        "The photograph does not necessarily correspond to a celestial event " +
                        "on the exact day that it is displayed, and images are sometimes repeated. " +
                        "However, the pictures and descriptions often relate to current events in astronomy " +
                        "and space exploration.",
                R.drawable.ic_undraw_launch_day_4e04),
            MainItem(
                2,
                "Mars Rover Photos",
                ...
                "This API is designed to collect image data gathered by NASA's Curiosity, " +
                        "Opportunity, and Spirit rovers on Mars and make it more easily available to other developers, " +
                        ...
                        "counting up from the rover's landing date. A photo taken on Curiosity's 1000th Martian sol exploring Mars, " +
                        "for example, will have a sol attribute of 1000. If instead you prefer to search by the Earth date " +
                        "on which a photo was taken, you can do that too.",
                R.drawable.ic_undraw_outer_space_drqu),
            ...
            MainItem(
                ...
                "NASA's image library, images.nasa.gov, consolidates imagery and videos in one searchable locations. " +
                        "Users can download content in multiple sizes and resolutions and see the metadata associated with images, " +
                        "including EXIF/camera data on many images.",
                R.drawable.ic_undraw_relaunch_day_902d),
        )
    }
}